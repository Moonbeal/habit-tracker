// pages/HabitsPage.jsx - ❗️ Повертаємо вузьку ширину 'max-w-md'
...
          <div>
            <h2 className='text-4xl sm:text-5xl font-extrabold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-purple-600 to-pink-500 dark:from-purple-400 dark:to-pink-400 pb-2'>
              Мої Звички
            </h2>
...
          </div>
          <div className='flex items-center gap-3'>
            <motion.button
              ...
              className='glass-card text-purple-700 dark:text-purple-200 p-4 rounded-2xl shadow-purple'
        ...
        <AnimatePresence>
          {habits.length > 0 && (
            <motion.div
              ...
              className='glass-card p-4 rounded-xl shadow-purple'
            >
...
          	exit={{ opacity: 0, y: -20 }}
          	className='glass-card border-l-4 border-purple-500 p-4 rounded-xl shadow-purple' 
          >
...
      {/* Фільтри */}
      <div className='glass-card p-4 rounded-xl shadow-purple'>
        <HabitFilters
...
    	<div className='glass-card text-center p-12 rounded-2xl flex flex-col items-center gap-4'>
          <SearchX size={48} className='text-purple-400' />
    	  <p className='text-purple-700 dark:text-purple-300 text-xl font-medium'>
            Нічого не знайдено
          </p>
